...
public class MainApp {
   public static void main(String[] args) {
      ...
      userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("BMW",31)));
      userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("BMW",14)));
      ...
      List<User> cars =  userService.getUserWithCar("BMW", 1);
      for (User c : cars) {
